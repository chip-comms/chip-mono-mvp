...
if [ ! -f ".env.local" ]; then
    ...
    if [ -f ".env.local.example" ]; then
        ...
        echo "  3. Accept pyannote terms: https://huggingface.co/pyannote/speaker-diarization-3.1"
        echo "  4. Get local Supabase service role key from: http://localhost:54323"
        echo ""
