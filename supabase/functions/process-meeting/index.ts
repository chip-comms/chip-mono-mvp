...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`🐍 Calling Python backend at: ${pythonBackendUrl}/api/analyze-meeting`)
    
    const pythonResponse = await fetch(`${pythonBackendUrl}/api/analyze-meeting`, {
      method: 'POST',
      headers: { 
    ...
    console.log('✅ Python backend processing started successfully:', pythonResult)
